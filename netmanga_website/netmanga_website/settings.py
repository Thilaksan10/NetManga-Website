...
CSP_STYLE_SRC = ("'self'",  "'unsafe-inline'",  "'unsafe-eval'", "https://netmanga.s3.amazonaws.com/css/", "https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css")
