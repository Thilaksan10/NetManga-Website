...
CSP_DEFAULT_SRC = ("'self'", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/fonts/")
...
CSP_IMG_SRC = ("'self'", "https://netmanga.s3.amazonaws.com/img/", "https://netmanga.s3.amazonaws.com/", "https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/")
CSP_FONT_SRC = ("'self'",)
