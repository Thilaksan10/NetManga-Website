...
from .forms import SignUpForm, LoginForm, CreatorForm, MangaForm, ChapterForm, EditProfileForm, EditMangaForm
from django.contrib.auth.models import User
from .models import Profile, Creator, Mangaseries, Chapter, Chapterimages, CoinOffer, Award, CoinPurchaseOrder, ChapterAward, Subscriber
...
class AnalyticsView(LoginRequiredMixin,TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if existing_creator is not None:
            ...
            return HttpResponse(template.render({'total_views':total_views,'total_subscriptions':total_subscriptions,'received_awards':received_awards,'daily_subscriptions_data':daily_subscriptions_data,'daily_awards_data':daily_awards_data,'daily_revenue_data':daily_revenue_data}, request))
        else:
