# Generated by Django 3.1 on 2021-04-09 22:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.ImageField(blank=True, default='no_profile_picture.png', null=True, upload_to='profilepictures/')),
                ('is_full_name_displayed', models.BooleanField(default=True)),
                ('bio', models.CharField(blank=True, max_length=500, null=True)),
                ('birth_date', models.DateField(blank=True, null=True)),
                ('advertise', models.BooleanField(default=False)),
                ('third_party_advertise', models.BooleanField(default=False)),
